<template>
    <win-fdialog :title="dialogTitle" class="GroupDialog" :before-close="closeGroupDialog" :visible.sync="dialogVisibleSon" :close-on-click-modal="false" :close-on-press-escape="false" width="1000px">
                ...
                <win-row>
                    <win-col :span="8">
                        <win-form-item label="组名称" prop="name">
                            <win-input v-model="groupReqVO.name" class="form-input" maxlength=50></win-input>
                        </win-form-item>
        ...
        <el-dialog width="30%" :title="deviceDialogTitle" :visible.sync="deviceDialogVisible" append-to-body>
                    ...
                    <win-row>
                        <win-col :span="12">
                            <win-form-item label="设备名称" prop="name">
                                <win-input v-model="deviceRepVO.name" maxlength=50 readonly="true"></win-input>
                            </win-form-item>
                        ...
                        <win-col :span="12">
                            ...
                            <win-form-item label="设备描述" prop="desc">
                                <win-input type="textarea" v-model="groupReqVO.desc" class="device-textarea" rows="3" maxlength="100" show-word-limit clearable></win-input>
                            </win-form-item>
                        </win-col>
                    </win-row>
                    <win-row>
                        <win-col :span="12">
                            <win-form-item label="连接状态" prop="status">
                                <win-input v-model="deviceRepVO.status" maxlength="50" readonly="true" placeholder="未连接"></win-input>
                            </win-form-item>
                        </win-col>
                        <win-col :span="12">
                            <win-button @click="connectTest('deviceForm')">连接测试</win-button>
                        </win-col>
                    </win-row>
                </div>
            </win-form>
